...
#include "KdwpCmd_ReferenceType_GetValues.hpp"
...
namespace jmdb
{
  ...
  KdwpCmd_ReferenceType_GetValues::~KdwpCmd_ReferenceType_GetValues()
  {
  ...
  ClientSocket const &
  operator<<(ClientSocket const &socket, KdwpCmd_ReferenceType_GetValues &cmd)
  {
